...
using Elkadeem.TicketManagement.Persistence.Configurations.CourseLibrary;
...
namespace Elkadeem.TicketManagement.Persistence.DbContexts.Courses
{
    public class CourseLibraryDbContext : BaseDbContext, ICourseLibraryDbContext
    {
        ...
        public CourseLibraryDbContext(IConfiguration configuration)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            var connectionString = _configuration.GetConnectionString("CourseLibraryConnectionString");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.ApplyConfigurationsFromAssembly(typeof(CourseLibraryDbContext).Assembly);
