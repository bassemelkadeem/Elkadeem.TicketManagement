...
{
    [DbContext(typeof(DishesDatabaseContext))]
    [Migration("20230620232032_AddDishesTablesAndSeedThem")]
    partial class AddDishesTablesAndSeedThem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elkadeem.TicketManagement.Domain.Dishes.Dish", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Elkadeem.TicketManagement.Domain.Dishes.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DishIngredient", b =>
                {
                    b.HasOne("Elkadeem.TicketManagement.Domain.Dishes.Dish", null)
                        .WithMany()
                        .HasForeignKey("DishesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Elkadeem.TicketManagement.Domain.Dishes.Ingredient", null)
                        .WithMany()
